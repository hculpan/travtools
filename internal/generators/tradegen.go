...
func modifiersForWorld(population string, starport string, amberZone, redZone bool) int {
	result := 0
...
func generatePassengers(passageClass string, startWorldPop, endWorldPop string, startStarport, endStarport string, startAmberZone, startRedZone, endAmberZone, endRedZone bool, distanceToDest int) int {
	...
	result += modifiersForWorld(startWorldPop, startStarport, startAmberZone, startRedZone)
	result += modifiersForWorld(endWorldPop, endStarport, endAmberZone, endRedZone)
